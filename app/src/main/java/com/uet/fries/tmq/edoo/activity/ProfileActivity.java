...
import com.uet.fries.tmq.edoo.adapter.ProfileAdapter;
import com.uet.fries.tmq.edoo.app.AppConfig;
import com.uet.fries.tmq.edoo.app.AppController;
import com.uet.fries.tmq.edoo.communication.MultipartRequest;
...
import com.uet.fries.tmq.edoo.util.UserPicture;
...
//                Log.d(TAG, "msg: " + message);
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            user.setAvatar(msg.getData().getString("avatar"));
            daoSession.clear();

            adapter.updateAvatar(user.getAvatar());
