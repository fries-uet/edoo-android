...
public class ItemSubject {
    ...
    public ItemSubject(String code, String name, String teacherName, String address, String period,
    ...
    public ItemSubject(String classId, String code, String name, String type, String semester, String teacherName, String address, String period,
    ...
    public ItemSubject(JSONObject lesson) {
        try {
     ...
     */
    public ItemSubject(HashMap<String, String> lesson) {
