...
import com.uet.fries.tmq.edoo.adapter.TimeLineAdapter;
...
public class TimelineActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemClass = (ItemClass) b.getSerializable("item_class");

        toolbar.setTitle(itemClass.getName());
    ...
    private void initAdapter() {
        ...
        mAdapter = new TimeLineAdapter(this, itemClass.getId());

        requestPost(itemClass.getId(), currPage, currTypeFilter);
    }
...
//                Log.i(TAG, "latest: " + lastVisibleItem);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.item_post:
//                Log.i(TAG, "new post");
                startPostWriterActivity(itemClass.getId());
                break;
