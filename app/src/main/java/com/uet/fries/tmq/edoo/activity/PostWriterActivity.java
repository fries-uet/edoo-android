...
import com.uet.fries.tmq.edoo.fragment.PostWriterContentFragment;
import com.uet.fries.tmq.edoo.fragment.PostWriterTagFragment;
    ...
    private void updatePost(String postId, String title, String content, boolean isIncognito, String type, String timeStamp) {
        ...
        try {
            ...
            if (type.equalsIgnoreCase(ItemTimeLinePost.TYPE_POST_EXERCISE))
                params.put("event_end", timeStamp);
        } catch (JSONException e) {
            e.printStackTrace();
        }
