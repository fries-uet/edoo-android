package com.uet.fries.tmq.edoo.communication;
...
public class RequestServer {
    ...
    private void initListener() {
        ...
        final boolean isLogin = PrefManager.isLoggedIn();
        final String token = PrefManager.getTokenLogin();
...
//        PrefManager.setIsSaveClass(false);
